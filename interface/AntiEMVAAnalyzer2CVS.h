...
class AntiEMVAAnalyzer2 : public edm::EDAnalyzer
{
 ...
 private:
  ...
  float Tau_AntiEVTightMVA3_;
  float Tau_DecayMode_;
  float Tau_MatchElePassVeto_;
  float Tau_CombIsoRaw_ ;
  float Tau_LooseCombIso_ ;
  float Tau_MediumCombIso_ ;
  float Tau_TightCombIso_ ;
  float Tau_Comb3HitsIsoRaw_ ;
  float Tau_LooseComb3HitsIso_ ;
  float Tau_MediumComb3HitsIso_ ;
  float Tau_TightComb3HitsIso_ ;
  float Tau_MVAIsoRaw_ ;
  float Tau_LooseMVAIso_ ;
  float Tau_MediumMVAIso_ ;
  float Tau_TightMVAIso_ ;
  float Tau_MVA2IsoRaw_ ;
  float Tau_LooseMVA2Iso_ ;
  float Tau_MediumMVA2Iso_ ;
  float Tau_TightMVA2Iso_ ;
