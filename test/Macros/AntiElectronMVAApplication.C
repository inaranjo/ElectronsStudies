...
//   std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/MVAOutput/V17/MvaOutput_AntiEMVA-v17EleVeto-All%s_%s.root",discriminator.data(),Type.data());
  std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/MVAOutput/V18/MvaOutput_AntiEMVA-v18EleVeto-All%s_%s.root",discriminator.data(),Type.data());
...
//     t_Tau_IsoMVALoose = Tau_IsoMVALoose;
    t_Tau_LooseComb3HitsIso = Tau_LooseComb3HitsIso;
    t_Tau_Eta = Tau_Eta;
