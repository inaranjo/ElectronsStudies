...
//   TString pathToFile = "/data_CMS/cms/ivo/AntiEMVANewTraining/Trees/AntiEMVATrees-DYJetsToLL-madgraph-DR53X-Summer12-iter2/";
  ...
  inputTree->Add(pathToFile+"/AntiEMVATrees-DYJetsToLL-madgraph-DR53X-Summer12-iter2/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-BBH130-pythia-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-BBH160-pythia-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-BBH180-pythia-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-BBH450-pythia-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-GGFH120-powheg-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-GGFH160-powheg-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-GGFH250-powheg-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-GGFH300-powheg-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-GGFH400-powheg-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-TTJets-madgraph-DR53X-Summer12-iter1/AntiEMVA*.root");
  inputTree->Add(pathToFile+"/AntiEMVATrees-VBFH120-powheg-DR53X-Summer12-iter1/AntiEMVA*.root");
...
//    std::string inputFileName = "/data_CMS/cms/ivo/AntiEMVANewTraning/Trees/AntiEMVATrees-DYJetsToLL-madgraph-DR53X-Summer12-iter2/AntiEMVA_V4.root";
...
//   std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVA/Trees/root/tree_testAntiEMVA%s_%s_%s.root",discriminator.data(),category.data(),matching.data());
  std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/root/tree_AntiEMVA-%s_%s_%s_%s.root",discriminator.data(),category.data(),matching.data(),Region.data());
...
//       cout<<" Tau_AbsEta :"<<t_Tau_AbsEta_<<endl;
      ...
      cout<<" Tau_AntiELooseMVA3 :"<<t_Tau_AntiELooseMVA3_<<endl; 
