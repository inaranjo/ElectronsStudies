...
//   inputTree->Add(pathToFile+"/AntiEMVATrees-VBFH120-powheg-DR53X-Summer12-iter3/AntiEMVA*.root");
  inputTree->Add("../AntiEMVA_test.root");
...
//   std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/root/tree_AntiEMVA-All%s_%s_%s_%s.root",discriminator.data(),category.data(),matching.data(),Region.data());
  std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/root/test/tree_AntiEMVA-DY%s_%s_%s_%s.root",discriminator.data(),category.data(),matching.data(),Region.data());
