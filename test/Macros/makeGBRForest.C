...
#include "TFile.h"
#include "/home/llr/cms/ivo/PFAntiElecMVA/CMSSW_5_3_11_patch3_NewTraining/src/CondFormats/EgammaObjects/interface/GBRForest.h"
#include "/home/llr/cms/ivo/PFAntiElecMVA/CMSSW_5_3_11_patch3_NewTraining/src/CondFormats/EgammaObjects/interface/GBRTree.h"
...
int main(int argc, char* argv[]) 
{
  ...
  //write to file
  fout->WriteObject(gbr_NoEleMatch_woGwoGSF_BL,"gbrtest");
  fout->WriteObject(gbr_NoEleMatch_woGwGSF_BL,"gbrtest");
  fout->WriteObject(gbr_NoEleMatch_wGwoGSF_BL,"gbrtest");
  fout->WriteObject(gbr_NoEleMatch_wGwGSF_BL,"gbrtest");
  fout->WriteObject(gbr_woGwoGSF_BL,"gbrtest");
  fout->WriteObject(gbr_woGwGSF_BL,"gbrtest");
  fout->WriteObject(gbr_wGwoGSF_BL,"gbrtest");
  fout->WriteObject(gbr_wGwGSF_BL,"gbrtest");
  fout->WriteObject(gbr_NoEleMatch_woGwoGSF_EC,"gbrtest");
  fout->WriteObject(gbr_NoEleMatch_woGwGSF_EC,"gbrtest");
  fout->WriteObject(gbr_NoEleMatch_wGwoGSF_EC,"gbrtest");
  fout->WriteObject(gbr_NoEleMatch_wGwGSF_EC,"gbrtest");
  fout->WriteObject(gbr_woGwoGSF_EC,"gbrtest");
  fout->WriteObject(gbr_woGwGSF_EC,"gbrtest");
  fout->WriteObject(gbr_wGwoGSF_EC,"gbrtest");
  fout->WriteObject(gbr_wGwGSF_EC,"gbrtest");
