...
float dCrackPhi(float phi, float eta){

  float pi= TMath::Pi();// 3.14159265358979323846;
  
  //Location of the 18 phi-cracks
  static std::vector<float> cPhi;
  if(cPhi.size()==0)
    {
      cPhi.resize(18,0);
      cPhi[0]=2.97025;
...
//compute the unsigned distance to the closest phi-crack in the barrel
float dCrackEta(float eta){
  
  //Location of the eta-cracks
  float cracks[5] = {0, 4.44747e-01, 7.92824e-01, 1.14090e+00, 1.47464e+00};
  
  float m=99.; //the result
  
  for(int i=0;i<5;i++){
    float d = minimum(eta-cracks[i], eta+cracks[i]);
	       ...
	       )
{
  ...
  TString pathToFile = "/data_CMS/cms/ivo/AntiEMVANewTraining/root/V17/";
  inputTree->Add(pathToFile+"/tree_AntiEMVA-All_NoEleMatch_woGwoGSF_Tau.root");
  inputTree->Add(pathToFile+"/tree_AntiEMVA-All_NoEleMatch_woGwoGSF_Elec.root");


//   TChain *inputTree = new TChain("tree");
// //   TString pathToFile = "/data_CMS/cms/ivo/AntiEMVANewTraining/Trees/AntiEMVATrees-DYJetsToLL-madgraph-DR53X-Summer12-iter2/";
//   TString pathToFile = "/data_CMS/cms/ivo/AntiEMVANewTraining/root/V1415/";
//   inputTree->Add(pathToFile+"/tree_AntiEMVA-All_Tau.root");
//   inputTree->Add(pathToFile+"/tree_AntiEMVA-All_Elec.root");
...
//   std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVA/Trees/MVAOutput/MvaOutput_AntiEMVA-v13EleVeto-DYJets%s_%s.root",discriminator.data(),Type.data());
//   std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/MVAOutput/V14/MvaOutput_AntiEMVA-v14EleVeto-DYJets%s_%s.root",discriminator.data(),Type.data());
//   std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/MVAOutput/V14/MvaOutput_AntiEMVA-v14EleVeto-All%s_%s.root",discriminator.data(),Type.data());
//   std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/MVAOutput/V16/MvaOutput_AntiEMVA-v16EleVeto-DYJets%s_%s.root",discriminator.data(),Type.data());
//   std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/MVAOutput/V16/MvaOutput_AntiEMVA-v16EleVeto-AllFromTraining%s_%s.root",discriminator.data(),Type.data());
//   std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/MVAOutput/V17/MvaOutput_AntiEMVA-v17EleVeto-All%s_%s.root",discriminator.data(),Type.data());
  std::string outputFileName = Form("/data_CMS/cms/ivo/AntiEMVANewTraining/MVAOutput/V18/MvaOutput_AntiEMVA-v18EleVeto-AllFromRoot%s_%s.root",discriminator.data(),Type.data());
...
//   float t_Tau_IsoMVALoose;
  float t_Tau_LooseComb3HitsIso;
  float t_Tau_Eta;
  float t_Tau_EtaAtEcalEntrance;
  float t_Tau_Pt;

  float t_Tau_AntiELoose;
  float t_Tau_AntiEMedium;
  float t_Tau_AntiETight;
  float t_Tau_AntiELooseMVA3;
  float t_Tau_AntiEMediumMVA3;
  float t_Tau_AntiETightMVA3;
  float t_Tau_AntiEVTightMVA3;
  float t_Tau_DecayMode;
  float t_Tau_MatchElePassVeto;
  float t_Tau_isInEcalCrack;
  float t_Tau_isInEcalCrack2;
  ...
  mytree->Branch("Tau_LooseComb3HitsIso",&t_Tau_LooseComb3HitsIso,"Tau_LooseComb3HitsIso/F");
//   mytree->Branch("Tau_IsoMVALoose",&t_Tau_IsoMVALoose,"Tau_IsoMVALoose/F");
  mytree->Branch("Tau_Eta",&t_Tau_Eta,"Tau_Eta/F");
  mytree->Branch("Tau_EtaAtEcalEntrance",&t_Tau_EtaAtEcalEntrance,"Tau_EtaAtEcalEntrance/F");
  mytree->Branch("Tau_Pt",&t_Tau_Pt,"Tau_Pt/F");

  mytree->Branch("Tau_AntiELoose",&t_Tau_AntiELoose,"Tau_AntiELoose/F");
  mytree->Branch("Tau_AntiEMedium",&t_Tau_AntiEMedium,"Tau_AntiEMedium/F");
  mytree->Branch("Tau_AntiETight",&t_Tau_AntiETight,"Tau_AntiETight/F");
  mytree->Branch("Tau_AntiELooseMVA3",&t_Tau_AntiELooseMVA3,"Tau_AntiELooseMVA3/F");
  mytree->Branch("Tau_AntiEMediumMVA3",&t_Tau_AntiEMediumMVA3,"Tau_AntiEMediumMVA3/F");
  mytree->Branch("Tau_AntiETightMVA3",&t_Tau_AntiETightMVA3,"Tau_AntiETightMVA3/F");
  mytree->Branch("Tau_AntiEVTightMVA3",&t_Tau_AntiEVTightMVA3,"Tau_AntiEVTightMVA3/F");
  mytree->Branch("Tau_MatchElePassVeto",&t_Tau_MatchElePassVeto,"Tau_MatchElePassVeto/F");
  mytree->Branch("Tau_isInEcalCrack",&t_Tau_isInEcalCrack,"Tau_isInEcalCrack/F");
  mytree->Branch("Tau_isInEcalCrack2",&t_Tau_isInEcalCrack2,"Tau_isInEcalCrack2/F");
  mytree->Branch("Tau_DecayMode",&t_Tau_DecayMode,"Tau_DecayMode/F");
  mytree->Branch("Tau_MatchElePassVeto",&t_Tau_MatchElePassVeto,"Tau_MatchElePassVeto/F");
...
//   inputTree->SetBranchAddress("Tau_IsoMVALoose", &Tau_IsoMVALoose); 
  ...
  cout<<"Tau_dCrackPhi 1 :"<<Tau_dCrackPhi<<endl;
  cout<<"Tau_dCrackEta 1:"<<Tau_dCrackEta<<endl;
...
//   string Weight_NoEleMatch_woGwoGSF_BL = "tmva/weights/V16/TMVAClassification_v16EleVeto_NoEleMatch_woGwoGSF_Barrel_BDTG.weights.xml";
//   string Weight_NoEleMatch_woGwGSF_BL = "tmva/weights/V16/TMVAClassification_v16EleVeto_NoEleMatch_woGwGSF_Barrel_BDTG.weights.xml";
//   string Weight_NoEleMatch_wGwoGSF_BL = "tmva/weights/V16/TMVAClassification_v16EleVeto_NoEleMatch_wGwoGSF_Barrel_BDTG.weights.xml";
//   string Weight_NoEleMatch_wGwGSF_BL = "tmva/weights/V16/TMVAClassification_v16EleVeto_NoEleMatch_wGwGSF_Barrel_BDTG.weights.xml";
//   string Weight_woGwoGSF_BL = "tmva/weights/V16/TMVAClassification_v16EleVeto_woGwoGSF_Barrel_BDTG.weights.xml";
//   string Weight_woGwGSF_BL = "tmva/weights/V16/TMVAClassification_v16EleVeto_woGwGSF_Barrel_BDTG.weights.xml";
//   string Weight_wGwoGSF_BL = "tmva/weights/V16/TMVAClassification_v16EleVeto_wGwoGSF_Barrel_BDTG.weights.xml";
//   string Weight_wGwGSF_BL = "tmva/weights/V16/TMVAClassification_v16EleVeto_wGwGSF_Barrel_BDTG.weights.xml";
//   string Weight_NoEleMatch_woGwoGSF_EC = "tmva/weights/V16/TMVAClassification_v16EleVeto_NoEleMatch_woGwoGSF_Endcap_BDTG.weights.xml";
//   string Weight_NoEleMatch_woGwGSF_EC = "tmva/weights/V16/TMVAClassification_v16EleVeto_NoEleMatch_woGwGSF_Endcap_BDTG.weights.xml";
//   string Weight_NoEleMatch_wGwoGSF_EC = "tmva/weights/V16/TMVAClassification_v16EleVeto_NoEleMatch_wGwoGSF_Endcap_BDTG.weights.xml";
//   string Weight_NoEleMatch_wGwGSF_EC = "tmva/weights/V16/TMVAClassification_v16EleVeto_NoEleMatch_wGwGSF_Endcap_BDTG.weights.xml";
//   string Weight_woGwoGSF_EC = "tmva/weights/V16/TMVAClassification_v16EleVeto_woGwoGSF_Endcap_BDTG.weights.xml";
//   string Weight_woGwGSF_EC = "tmva/weights/V16/TMVAClassification_v16EleVeto_woGwGSF_Endcap_BDTG.weights.xml";
//   string Weight_wGwoGSF_EC = "tmva/weights/V16/TMVAClassification_v16EleVeto_wGwoGSF_Endcap_BDTG.weights.xml";
//   string Weight_wGwGSF_EC = "tmva/weights/V16/TMVAClassification_v16EleVeto_wGwGSF_Endcap_BDTG.weights.xml";

//   string Weight_NoEleMatch_woGwoGSF_BL = "tmva/weights/V17/TMVAClassification_v17EleVeto_NoEleMatch_woGwoGSF_Barrel_BDTG.weights.xml";
//   string Weight_NoEleMatch_woGwGSF_BL = "tmva/weights/V17/TMVAClassification_v17EleVeto_NoEleMatch_woGwGSF_Barrel_BDTG.weights.xml";
//   string Weight_NoEleMatch_wGwoGSF_BL = "tmva/weights/V17/TMVAClassification_v17EleVeto_NoEleMatch_wGwoGSF_Barrel_BDTG.weights.xml";
//   string Weight_NoEleMatch_wGwGSF_BL = "tmva/weights/V17/TMVAClassification_v17EleVeto_NoEleMatch_wGwGSF_Barrel_BDTG.weights.xml";
//   string Weight_woGwoGSF_BL = "tmva/weights/V17/TMVAClassification_v17EleVeto_woGwoGSF_Barrel_BDTG.weights.xml";
//   string Weight_woGwGSF_BL = "tmva/weights/V17/TMVAClassification_v17EleVeto_woGwGSF_Barrel_BDTG.weights.xml";
//   string Weight_wGwoGSF_BL = "tmva/weights/V17/TMVAClassification_v17EleVeto_wGwoGSF_Barrel_BDTG.weights.xml";
//   string Weight_wGwGSF_BL = "tmva/weights/V17/TMVAClassification_v17EleVeto_wGwGSF_Barrel_BDTG.weights.xml";
//   string Weight_NoEleMatch_woGwoGSF_EC = "tmva/weights/V17/TMVAClassification_v17EleVeto_NoEleMatch_woGwoGSF_Endcap_BDTG.weights.xml";
//   string Weight_NoEleMatch_woGwGSF_EC = "tmva/weights/V17/TMVAClassification_v17EleVeto_NoEleMatch_woGwGSF_Endcap_BDTG.weights.xml";
//   string Weight_NoEleMatch_wGwoGSF_EC = "tmva/weights/V17/TMVAClassification_v17EleVeto_NoEleMatch_wGwoGSF_Endcap_BDTG.weights.xml";
//   string Weight_NoEleMatch_wGwGSF_EC = "tmva/weights/V17/TMVAClassification_v17EleVeto_NoEleMatch_wGwGSF_Endcap_BDTG.weights.xml";
//   string Weight_woGwoGSF_EC = "tmva/weights/V17/TMVAClassification_v17EleVeto_woGwoGSF_Endcap_BDTG.weights.xml";
//   string Weight_woGwGSF_EC = "tmva/weights/V17/TMVAClassification_v17EleVeto_woGwGSF_Endcap_BDTG.weights.xml";
//   string Weight_wGwoGSF_EC = "tmva/weights/V17/TMVAClassification_v17EleVeto_wGwoGSF_Endcap_BDTG.weights.xml";
//   string Weight_wGwGSF_EC = "tmva/weights/V17/TMVAClassification_v17EleVeto_wGwGSF_Endcap_BDTG.weights.xml";
...
//     if(Tau_LooseComb3HitsIso!=1) continue;
    ...
    Tau_NumHitsVariable = (Tau_GSFNumHits - Tau_KFNumHits)/(Tau_GSFNumHits + Tau_KFNumHits);
    Tau_dCrackPhi = dCrackPhi(Tau_PhiAtEcalEntrance,Tau_EtaAtEcalEntrance) ;
    Tau_dCrackEta = dCrackEta(Tau_EtaAtEcalEntrance) ;
...
//    if(event!=70923808 && lumi !=177451 )continue;
//     if(Tau_Pt<43.34 || Tau_Pt>43.35)continue;
...
//     t_Tau_IsoMVALoose = Tau_IsoMVALoose;
    t_Tau_LooseComb3HitsIso = 1;
    t_Tau_Eta = Tau_Eta;
    t_Tau_EtaAtEcalEntrance = Tau_EtaAtEcalEntrance;
    t_Tau_Pt = Tau_Pt;
    t_Tau_AntiELoose = Tau_AntiELoose;
    t_Tau_AntiEMedium = Tau_AntiEMedium;
    t_Tau_AntiETight = Tau_AntiETight;
    t_Tau_AntiELooseMVA3 = Tau_AntiELooseMVA3;
    t_Tau_AntiEMediumMVA3 = Tau_AntiEMediumMVA3;
    t_Tau_AntiETightMVA3 = Tau_AntiETightMVA3;
    t_Tau_AntiEVTightMVA3 = Tau_AntiEVTightMVA3;
//     if(ElecVeto_Pt > -99) t_Tau_MatchElePassVeto = 1.;
//     else t_Tau_MatchElePassVeto = 0.;
    t_Tau_MatchElePassVeto = Tau_MatchElePassVeto;
    t_Tau_DecayMode = Tau_DecayMode;
...
//     cout<<"lumi :"<<lumi<<endl;
//     cout<<"pt   :"<<Tau_Pt<<endl;
//     cout<<"eta  :"<<Tau_EtaAtEcalEntrance<<endl;
//     cout<<"Tau_EmFraction  :"<<Tau_EmFraction<<endl;
//     cout<<"Tau_HadrHoP     :"<<Tau_HadrHoP<<endl;
//     cout<<"Tau_HadrEoP     :"<<Tau_HadrEoP<<endl;
//     cout<<"Tau_ViMass      :"<<Tau_VisMass<<endl;
//     cout<<"Tau_dCrackEta   :"<<Tau_dCrackEta<<endl;
//     cout<<"Tau_dCrackPhi   :"<<Tau_dCrackPhi<<endl;
//     cout<<"Raw MVA :"<<t_rawMva<<endl;
//     cout<<endl;
